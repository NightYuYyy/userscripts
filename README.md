...
| [\[银河奶牛\]库存物品一键自动出售（极速版）v2](mwi-auto-sell-v2/) | 2.0.0 | `https://www.milkywayidle.com/game*` | 选中库存物品后按 S：前往市场 → 新出售挂牌 → 价格+1 → 最多 → 发布 → 关闭。逐步轮询等待按钮出现，无固定延迟。 | [安装](https://raw.githubusercontent.com/NightYuYyy/userscripts/main/mwi-auto-sell-v2/mwi-auto-sell-v2.user.js) |
